...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 18, 2021 at 08:51 AM
...
(3, 'Sri lanka', '12-06-2021', '12.00 AM', 'Australia', '13-06-2021', '12.00 PM', 1),
(6, 'Korea', '2021-10-28', '12.00 AM', 'Sri Lanka', '2021-10-29', '6.00 AM', 1);
...
(9, 'YAsas Wikramasinghe', '2345674685644343', '05', '2024', 2345);
...
(1, 'Supun kariyawas', 'sri lanka', '567/3,Thalawatthe,Kandy', '1234', '1234', '6765343455', 'supun2105@gmail.com'),
(3, 'Sugath Amarawansha', 'India', '405/5,rosawatta,katugasthota', 's1234', 's1234', '0786756123', 'suagth123@gmail.com');
...
INSERT INTO `staff` (`staff_ID`, `sName`, `sEmail`, `password`, `cPassword`) VALUES
(1, 'Supun Premarathna', 'premarathna123@gmail.com', 'sup1234', 'sup1234'),
(3, 'Dewmini Senanayake', 'dew123@gmail.com', 'dew12345', 'dew12345');
...
--
ALTER TABLE `booking`
  MODIFY `bID` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
ALTER TABLE `helpdesk`
  MODIFY `hpID` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
